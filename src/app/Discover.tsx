...
import { SUPER_VYBE_DAILY_LIMIT } from "@/lib/constants";
...
export default function Discover() {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Header */}
      <header className="flex items-end justify-between px-5 pt-safe pb-2 pt-4">
        <div>
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 p-4">
          ...
          <button
            ...
            className="mt-3 flex items-center gap-1 text-xs font-semibold text-white/70"
          >
